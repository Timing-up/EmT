...
if __name__ == '__main__':
    ...
    parser.add_argument('--num-channel', type=int, default=62)  # 54 for TSception 62
    parser.add_argument('--num-time', type=int, default=512)
    ...
    parser.add_argument('--max-epoch', type=int, default=10)  #10
    parser.add_argument('--patient', type=int, default=10)
    parser.add_argument('--patient-cmb', type=int, default=2)
    parser.add_argument('--max-epoch-cmb', type=int, default=100)
    ...
    parser.add_argument('--layers-transformer', type=int, default=8)
    ...
    parser.add_argument('--K', type=int, default=4, help='K for ChebyNet')
    ...
    cv.leave_sub_out(subject=sub_to_run, shuffle=False)
